...
class HTML:
    def __init__(self):
        ...
        self.innerHTML['GHL']['Main'] = {
            ...
            "Email": "#email",
            "Password": "#password",
            'Login btn': '#app > div.undefined.flex.v2-open.sidebar-v2-agency > section > div.hl_login--body > div > div > div > div:nth-child(4) > div:nth-child(2) > button',
            'Send Secruity btn': "#app > div.undefined.flex.v2-open.sidebar-v2-agency > section > div.hl_login--body > div > div > div > div > div.form-group.button-holder > div:nth-child(2) > button",
            'Opportunities': '#sb_opportunities',
            'Locations': '#location-switcher-sidbar-v2 > div.flex.flex-row.items-center.mr-1.md\:hidden.lg\:block.xl\:block.w-36 > div > span',
            ...
            'Houston Location': '#location-list > div:nth-child(1) > div:nth-child(2)',
        ...
        self.selectors['har'] = {
            ...
            'listing_dom_check': '#wrapperTable > tbody > tr > td > span > table > tbody > tr:nth-child(5) > td.display.d48m10 > table > tbody > tr.d48m11 > td.d48m15 > table > tbody > tr:nth-child(3) > td.d48m17',
