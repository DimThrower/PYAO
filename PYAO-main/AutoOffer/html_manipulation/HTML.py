...
class HTML:
    def __init__(self):
        ...
        self.innerHTML['saved search page']['saved search name'] = 'Stale Homes'
        ...
        self.innerHTML['GHL']['Main'] = {
            ...
            'Create Contact': 'body > div.n-modal-container > div > div > div.n-scrollbar-container > div > div.n-card.n-modal.hl-modal > div:nth-child(3) > div > div > div.n-base-select-menu__action > div',
        ...
        self.selectors['har'] = {
            'user': '#username',
            'password': '#password',
            'privacy_confirm_btn': '#ketch-consent-banner > div.ketch-flex.ketch-max-h-full.ketch-flex-1.ketch-flex-col.ketch-justify-between.ketch-overflow-hidden.ketch-pb-3.ketch-pt-4.ketch-items-start.ketch-gap-5 > div > div > div.ketch-w-full.ketch-flex-col.ketch-items-stretch.ketch-flex.ketch-shrink-0.ketch-grow-0.ketch-gap-3.sm\:ketch-items-stretch.sm\:ketch-w-full.ketch-pt-0\.5.ketch-mt-5 > button.ketch-relative.ketch-inline-flex.ketch-items-center.ketch-justify-center.ketch-font-semibold.ketch-transition.ketch-duration-300.ketch-ease-in-out.ketch-cursor-pointer.ketch-shadow-none.focus-visible\:ketch-outline.focus-visible\:ketch-outline-2.focus-visible\:ketch-outline-default-outline.ketch-overflow-hidden.ketch-rounded-none.ketch-border-\[1\.5px\].ketch-border-black.ketch-border-solid.ketch-text-black.ketch-bg-transparent.ketch-gap-3.active\:ketch-bg-gradient-to-r.active\:ketch-from-states-pressed-darken.active\:ketch-to-states-pressed-darken.hover\:ketch-bg-gradient-to-r.hover\:ketch-from-states-hover-darken.hover\:ketch-to-states-hover-darken.focus-visible\:ketch-bg-gradient-to-r.focus-visible\:ketch-from-states-focus-darken.focus-visible\:ketch-to-states-focus-darken.focus-visible\:ketch-outline-offset-2.ketch-min-h-10.ketch-text-ketch-l.ketch-px-4.ketch-w-full.sm\:ketch-w-auto.\!ketch-rounded-\[--k-banner-buttons-primary-cornerRadius\].\!ketch-text-\[--k-banner-buttons-primary-text-color\].\!ketch-border-\[--k-banner-buttons-primary-background-color\].focus-visible\:\!ketch-outline.\!ketch-outline-2.\!ketch-outline-ketch-black-black-100.\!ketch-outline-offset-2.lm\:ketch-text-ketch-lm.disabled\:ketch-cursor-not-allowed.disabled\:ketch-pointer-events-none.disabled\:ketch-select-none.disabled\:ketch-opacity-\[\.24\]',
            'login_btn': '#login_btn',
            # 'matrix': 'body > div.pageContent > div.pc_content.color_carbon > div.row.mb30 > div.col-md-4.col-12.order-md-2.order-0 > div:nth-child(1) > a',
            'matrix': '/html/body/div[5]/div[3]/div[2]/div[2]/div[1]/a',
            ...
            'flood_link': '#wrapperTable > div > div > div:nth-child(3) > div > span > div.mtx-containerNavTabs > ul > li:nth-child(6) > a',
            'flood_code': '#wrapperTable > tbody > tr > td > table > tbody > tr:nth-child(1) > td.d223m3 > table > tbody > tr:nth-child(1) > td:nth-child(2) > span',
        }
# <a class="btn btn--prominent mb20 btn--simple" style="padding-top:10px !important;" target="_blank" href="/moa_mls/goMatrix">Access Matrix MLS</a>